...
public class LoginInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request,
        ...
        FloorEmployeeEntity floorEmployeeEntity = (FloorEmployeeEntity) request.getSession().getAttribute("user");
        if (floorEmployeeEntity == null) {
