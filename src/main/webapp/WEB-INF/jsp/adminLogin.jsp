        ...
        <div class="col-md-6 col-lg-6">
            <div class="login-and-register-container">
                ...
                <div class="login-box">
                    ...
                    <form id="loginForm" action="/admin/login/login" method="post">
                        <div class="=form-group">
                            <label for="employeeId">工号 </label>
                            <input type="text" class="form-control validate[required,custom[number]]" id="employeeId"
                                   name="employeeId" placeholder="工号" value="">
                        </div>
                        <div class="=form-group">
